...
chapter_1/「旅立ち」
  ✓ episode_1.md「目覚め」 — 3,100字 — 確定
  ✓ episode_2.md「出会い」 — 2,800字 — 確定
  ✓ episode_3.md「決意」 — 3,200字 — 確定
  ✓ episode_4.md「門出」 — 2,900字 — 確定

chapter_2/「試練」
  ✓ episode_5.md「嵐の前」 — 3,400字 — 確定
  ⏳ episode_6.md「対峙」 — 執筆中
...
- Episode ファイル: `output/episodes/chapter_{N}/episode_{M}.md`
